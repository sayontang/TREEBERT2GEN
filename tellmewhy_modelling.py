...
def parse():
    ...
    parser.add_argument('-max_steps', type = int, default= 12000, help="Number of epochs")
    ...
    parser.add_argument('-eval_step', type = int, default= 300, help="Steps between two different evaluations")
...
if __name__ == '__main__':  
    ...
    val_path = 'tellmewhy_val.txt.seq.with_missing.pt'
    ...
    ip_data_files = ['tellmewhy_train.txt.seq.with_missing.pt']
